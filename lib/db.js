...
function createJob({ name, skill_name = '', cron_expr = '', arguments: args = '', enabled = 1, run_on_wake = 1, timeout_ms = 600000, idle_timeout_ms = 300000, max_retries = 1, discord_notify = 0, job_type = 'claude', command = null, routine = 0 }) {
