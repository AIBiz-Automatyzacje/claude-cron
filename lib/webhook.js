...
// Query string → płaski obiekt. Webhook wyzwalany GET-em (przyciski "Open URL"
// w Airtable/Notion — jedyna metoda, jaką umieją) niesie dane właśnie tutaj,
// bo ciała nie wyśle. Powtórzony klucz (?a=1&a=2) daje ostatnią wartość:
// webhooki nie mają przypadku użycia na tablice, a płaski obiekt jest
// przewidywalny dla skryptów czytających payload.
...
module.exports = { matchWebhookToken, matchAskToken, queryParams };
